                    ...
                    <tbody>
                        <?php while ($post = mysqli_fetch_assoc($posts)) : ?>
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo 'http://localhost/legacylearning/'?>admin/edit-post.php?id=<?= $post['id'] ?>" class="btn sm">Edit</a></td>
                                <td><a href="<?php echo 'http://localhost/legacylearning/'?>admin/delete-post.php?id=<?= $post['id'] ?>" class="btn sm danger">Delete</a></td>
                            </tr>
                        <?php endwhile ?>
                    </tbody>
                </table>
